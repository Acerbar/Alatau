...
document.addEventListener('click', function (event) {
    ...
    /**if(event.target.closest(openButton1)){
        serviceText1.classList.add('item-more-1__active');
    }
    else if(!event.target.closest('.open-button-more-1')){
        serviceText1.classList.remove('item-more-1__active');
    }**/
}
);
const serviceContent = document.querySelector('.section__content');
const openButton1 = document.querySelector('.open-button-more-1');
const openButton2 = document.querySelector('.open-button-more-2');
const openButton3 = document.querySelector('.open-button-more-3');
const serviceText1 = document.querySelector('.item-more-1');
const serviceText2 = document.querySelector('.item-more-2');
const serviceText3 = document.querySelector('.item-more-3');

serviceContent.addEventListener('click', function(event){
    if (event.target.closest('.open-button-more-1')){
    serviceText1.classList.add('item-more-1__active');
    openButton1.classList.add('open-button-more-1__hidden');
    }
    else if(event.target.closest('.close-button-more-1')){
    serviceText1.classList.remove('item-more-1__active');
    openButton1.classList.remove('open-button-more-1__hidden');
    }

    else if (event.target.closest('.open-button-more-2')){
        serviceText2.classList.add('item-more-2__active');
        openButton2.classList.add('open-button-more-2__hidden');
        }
    else if (event.target.closest('.close-button-more-2')){
        serviceText2.classList.remove('item-more-2__active');
        openButton2.classList.remove('open-button-more-2__hidden');
        }

    else if (event.target.closest('.open-button-more-3')){
        serviceText3.classList.add('item-more-3__active');
        openButton3.classList.add('open-button-more-3__hidden');
        }
    else if (event.target.closest('.close-button-more-3')){
        serviceText3.classList.remove('item-more-3__active');
        openButton3.classList.remove('open-button-more-3__hidden');
        }
})
